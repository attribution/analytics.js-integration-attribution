...
var fixRelativeUrl = require('./middleware/fixRelativeUrl');
...
Attribution.prototype.initialize = function() {
  // Add middleware to fix relative urls
  this.analytics.addSourceMiddleware(fixRelativeUrl);
...
Attribution.prototype.setAnonymousIdFromQuery = function(query) {
  var idFromQuery = parse(query).anonymous_id;
  if (idFromQuery) {
